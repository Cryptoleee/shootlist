...
**Eenmalige setup:** Vercel-dashboard → project *shootlist* → **Storage** → **Create Database** → *Upstash Redis* (gratis tier) → koppel aan het project → redeploy (gebeurt automatisch bij de eerstvolgende push). Daarna toont de app "☁️ synct" in de balk. Zonder database staat er "alleen dit toestel" en werkt alles lokaal zoals voorheen.
